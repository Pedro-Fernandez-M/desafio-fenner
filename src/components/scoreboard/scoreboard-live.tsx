...
export function ScoreboardLive() {
  ...
  return (
    <>
      ...
      {/* Aviso de actualización de clases */}
      <div className="mt-8 flex items-center justify-center gap-2 rounded-xl border border-amber-400/30 bg-amber-400/10 px-4 py-3 text-center text-sm text-amber-100">
        <CalendarClock className="size-4 shrink-0" />
        Los datos de las clases se actualizan los viernes. Las anotaciones de
        Convivencia y los descuentos se reflejan al instante.
      </div>
    </>
  )
}
